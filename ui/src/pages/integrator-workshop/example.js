...
export const developers = [
    {
        ...
        about: `Здравствуйте. я - профессионал своего дела. Разрабатываю: программные обеспечения любой сложности, игры, CRM системы, мобильные приложения, сайты, оптимизацию производства крупных, средних и начинающих предприятий, обеспечиваю защиту конфиденциальных данных от взлома и кражи, защиту от DDoS атак, осуществляю поиск и устранение уязвимостей. Мои преимущества: полная конфиденциальность данных клиента, оперативная разработка проектов любой сложности, подробное комментирование кода, а так же всех исходных данных. На профессиональном уровне владею языками: C#,C++,PHP, JavaScript, Java, Swift, JSON, HTML, CSS, Python, SQL, R, P`,
        projects: [
    ...
    },
    {
        ...
        about: `Опыт программирования более 9 лет. Гениальный подход в программировании )  `,
        projects: [
            'https://github.com/ziadoz/awesome-php',
            'https://heml.io/',
            'http://www.vanillalist.com/',
    ...
    },
    {
        ...
        about: `Разрабатываю программное обеспечение различной сложности (веб-сайт,CRM, мобильные приложения, облако, машинное обучение, искусственный интеллект AI)`,
        projects: [
            'https://github.com/ziadoz/awesome-php',
            'https://heml.io/',
            'http://www.vanillalist.com/',
    ...
    },
    {
        ...
        yearsOfExperience: 1,
        proffession: 'Frontend-developer',
        about: `Full-stack веб-разработчик / Программист. Разрабатываю веб-приложения с 2012 года. Сайты, интернет-магазины, веб-приложения для автоматизации бизнеса. Адаптация под мобильные устройства. --- Чем занимаюсь: Разработка адаптивных к мобильным устройствам сайтов и интернет магазинов на быстром, удобном, простом в использовании движке. Веб-приложения для автоматизации бизнес процессов. Вникаю в тонкости бизнеса клиента до мелочей, создаю полезные и эффективные системы. Всегда довожу начатое до конца.`,
        projects: [
            'https://github.com/ziadoz/awesome-php',
            'https://heml.io/',
            'http://www.vanillalist.com/',
    ...
    },
    {
        ...
        about: `20 лет работаю в области информационных технологий. Знаю многие языки программирования, базы данных, средств разработки. Много лет занимаюсь разработкой и программированием электроники на базе Arduino, ESP8266, ESP32.`,
        projects: [
            'https://github.com/ziadoz/awesome-php',
            'https://heml.io/',
            'http://www.vanillalist.com/',
